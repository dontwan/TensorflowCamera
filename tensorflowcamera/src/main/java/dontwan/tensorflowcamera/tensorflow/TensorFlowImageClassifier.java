...
public class TensorFlowImageClassifier implements Classifier {
    ...
    public TensorFlowImageClassifier(Context context) {
        this.inferenceInterface = new TensorFlowInferenceInterface(context.getAssets(), TensorFlowCamera.getModelFile());
     ...
     *              and power consuming.
     */
    public synchronized List<Recognition> doRecognize(Bitmap image) {
